...
session_start();
if (isset($_SESSION['loginfront'])) { //jika sudah login
    //menampilkan isi session
    // echo "<h1>Selamat Datang " . $_SESSION['login'] . "</h1>";
    // echo "<h2>Halaman ini hanya bisa diakses jika Anda sudah login</h2>";
    // echo "<h2>Klik <a href='session3.php'>di sini (session03.php)</a> untuk LOGOUT</h2>";
} else {
    die("Anda belum login! Anda tidak berhak masuk ke halaman ini.Silahkan login <a href='admin/login.php'>di sini</a>");
...
<p class="text-center">
        ...
        <div class="text-center">
          <br>Copyright ©️ Program Studi Teknik Informatika - <?=date('Y');?><br>
        </div>
      </div>
    </div>
